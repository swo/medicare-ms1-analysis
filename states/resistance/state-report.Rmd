...
I want to be able to filter the bug/drug combinations by whether they are coherent in the resistance data. Does the geography (state or HRR) actually have any effect on the 
...
all_result %>%
  ...
  ggplot(aes(x=correlation, y=coherent.adj.p.value)) +
  geom_point() +
  geom_abline(yintercept=0.05, col='red') +
  scale_y_reverse() +
  theme_minimal()
```
