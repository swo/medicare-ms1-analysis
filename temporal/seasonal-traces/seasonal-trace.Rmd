---
title: "Seasonal patterns for azithromycin across states"
author: "Scott Olesen"
date: "2/15/2017"
...
Azithromycin has a seasonal pattern in prescriptions. Does that pattern vary by geography? I used the Medicare data.

```{r load_data, echo=FALSE, message=FALSE}
dat2011 = read_tsv('../temporal-abx-2011.tsv')

full_dat = lapply(2011:2014, function(x) { read_tsv(sprintf('../temporal-abx-%i.tsv', x)) %>% mutate(year=x) }) %>%
  bind_rows()
```
