...
ineq %>%
  # use only 2011 data
  filter(year==2011, unit_type=='state') %>%
  # sum across unit types
  group_by(drug_group, n_claims) %>%
  ...
  select(drug_group, n_claims, pct_bene, pct_claims) %>%
