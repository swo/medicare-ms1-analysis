...
analyze = function(this_year) {
  ...
  cc = read_tsv(sprintf('../../data/cc_%i.tsv', this_year))
...
chars_by_consumption = data_by_field('chars_by_consumption') %>%
  arrange(desc(y), desc(claims_group)) %>%
  kable
