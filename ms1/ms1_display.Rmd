...
If a drug declined by $X$, then the optimal change in the high tier fraction would be $1/(1-X) \approx 1+X$. For example, overall prescribing fell by about 5%, and high-tier prescribing increased by 2.5%. Azithromycin prescribing fell by about 20%, and high-tier azithro prescribing rose by only 6%.
