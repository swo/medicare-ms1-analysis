...
pde_approp_trends = read_tsv('tables/pde_approp_trends.tsv') %>%
  ...
  select(antibiotic, pct_change=estimate, ci_low, ci_high, adj.p) # now estimate is adjusted change
```
...
ggplot(adjusted_changes, aes(x=antibiotic, y=pct_change, ymin=ci_low, ymax=ci_high)) +
  geom_hline(yintercept=0) +
  geom_bar(dat=adjusted_changes, stat='identity', fill=NA, color='black') +
  geom_errorbar(dat=adjusted_changes, width=0.5) +
  geom_point(dat=unadjusted_changes, aes(ymin=NULL, ymax=NULL), shape=1) +
